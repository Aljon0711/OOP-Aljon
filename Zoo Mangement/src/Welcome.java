...
public class Welcome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Animal Kingdom");
    ...
    if (proceedConfirmation == JOptionPane.YES_OPTION) {
        // If user chooses to proceed, show welcome message
        ...
        // If user chooses not to proceed, ask for confirmation to exit
        int exitConfirmation = JOptionPane.showConfirmDialog(null, 
            "Are you sure you want to exit?", "Exit Confirmation",
            JOptionPane.YES_NO_OPTION);
        
        if (exitConfirmation == JOptionPane.YES_OPTION) {
            // If user confirms to exit, exit the program
            System.exit(0);
        }
    }
